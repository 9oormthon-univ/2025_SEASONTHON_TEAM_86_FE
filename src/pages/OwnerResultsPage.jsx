    ...
    <>
      ...
      <Container>
        {loading ? (
          ...
          <>
            <Title>
              가맹 투표 브랜드, <Bold>Top 3</Bold> <Highlight> 최종 순위</Highlight>는?
              <br />
              나의 <Highlight>음식점</Highlight>을 <Bold>찾아보세요.</Bold>
            </Title>
            ...
            <LowerRankingList>
              {restaurants.map((restaurant, idx) => (
                ...
                >
                  ...
                  <InfoBox>
                    <RestaurantNameSmall>{restaurant.restaurantName}</RestaurantNameSmall>
                    <RestaurantDescSmall>{restaurant.restaurantInfo}</RestaurantDescSmall>
                  </InfoBox>
                  <LikeBoxRow>
                    <HeartIcon src={heart} alt="heart" />
                    {restaurant.restaurantLike}
...
const RestaurantCard = styled.div`
  ...
  margin: 0 auto;
  cursor: pointer;   /* 마우스 올렸을 때 클릭 표시 */

  /* hover 시 반투명 흰색 overlay */
  &:hover::after {
    content: "";
    position: absolute;
    top: 0;
    ...
    width: 100%;
    height: 100%;
    background: rgba(255, 255, 255, 0.2); /* 흰색 + 투명도 */
    border-radius: 20px; /* CardImage 둥근 모서리와 맞춤 */
